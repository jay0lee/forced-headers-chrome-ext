...
| :--- | :--- | :--- | :--- |
| **Microsoft Entra ID** | `sec-Restrict-Tenant-Access-Policy` (v2)<br>`Restrict-Access-To-Tenants` (v1) | `restrict-msa;mytenant.onmicrosoft.com`<br>`contoso.com, fabrikam.com` | [Docs](https://learn.microsoft.com/en-us/entra/identity/enterprise-apps/tenant-restrictions-v2) |
